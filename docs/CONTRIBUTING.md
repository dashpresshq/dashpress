...
4. Commit your changes (`git commit -m 'feat: add amazing_feature'`) Hadmean uses [conventional commits](https://www.conventionalcommits.org), so please follow the specification in your commit messages.
