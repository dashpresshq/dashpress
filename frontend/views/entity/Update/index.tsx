...
export function EntityUpdate() {
  ...
  const actionItems = useEntityActionMenuItems([EntityActionTypes.Update, EntityActionTypes.Types]);
        ...
        >
          ...
          {!isLoading && !error && (
            <UpdateEntityForm
              ...
              fields={fitlerOutHiddenScalarColumns(entityScalarFields, hiddenUpdateColumns).map(
                ({ name }) => name,
              )}
