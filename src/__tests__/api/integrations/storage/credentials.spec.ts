...
import handler from "@/pages/api/integrations/storage/credentials";
import {
...
describe("/api/integrations/storage/[key]/credentials", () => {
  beforeAll(async () => {
    ...
    await setupCredentialsTestData({
      ...
      FILE_STORAGE__S3___accessKeyId:
      ...
      FILE_STORAGE__S3___secretAccessKey:
      ...
      FILE_STORAGE__S3___shouldNotShowUp:
