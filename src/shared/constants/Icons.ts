export const SystemIcons: Record<string, string> = {
  ...
  Box: ` <path d="M21 16V8a2 2 0 00-.991-1.725L20 6.27l-7-4c-.287-.168-.632-.268-1-.268s-.713.099-1.009.273L11 2.27l-7 4A2.003 2.003 0 003 8v8a2 2 0 00.991 1.725L4 17.73l7 4c.287.168.632.268 1 .268s.713-.099 1.009-.273L13 21.73l7-4A2.003 2.003 0 0021 16v0z" />
  ...
  CheckSquare: `  <path d="M9 11l3 3L22 4" />
    <path d="M21 12v7a2 2 0 01-2 2v0H5a2 2 0 01-2-2v0V5a2 2 0 012-2v0h11" />`,
  ...
  File: `        <path d="M13 2H6a2 2 0 00-2 2v16a2 2 0 002 2v0h12a2 2 0 002-2v0V9z" />
    <path d="M13 2v7h7" />`,
  ...
  Globe: ` <path d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2s10 4.477 10 10zM2 12h20" />
    <path d="M12 2a15.235 15.235 0 014 9.983V12a15.254 15.254 0 01-4.01 10.011l.01-.012a15.235 15.235 0 01-4-9.983v-.017a15.254 15.254 0 014.01-10.011L12 2z" />`,
  ...
  Home: `<path d="M3 9l9-7 9 7v11a2 2 0 01-2 2v0H5a2 2 0 01-2-2v0z" />
    <path d="M9 22V12h6v10" />
<path d="M9 22V12h6v10" />`,
  Image: `  <path d="M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z" />
    <path d="M10 8.5a1.5 1.5 0 11-3.001-.001A1.5 1.5 0 0110 8.5zM21 15l-5-5L5 21" />`,
  Info: `<path d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2s10 4.477 10 10zM12 16v-4M12 8h.01" />`,
  Link: `  <path d="M10 13a4.998 4.998 0 007.54.54l3-3a5 5 0 00-7.071-7.069l.001-.001-1.72 1.71" />
    <path d="M14 11a4.998 4.998 0 00-7.54-.54l-3 3a5 5 0 007.071 7.069l-.001.001 1.71-1.71" />`,
  ...
  PieChart: `<path d="M21.21 15.89c-1.559 3.618-5.094 6.105-9.21 6.105-5.523 0-10-4.477-10-10 0-4.076 2.439-7.583 5.937-9.14l.064-.025" />
    <path d="M22 12c0-5.523-4.477-10-10-10v10z" />`,
  ...
  Truck: `   <path d="M1 3h15v13H1V3zM16 8h4l3 3v5h-7V8z" />
    <path d="M8 18.5a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0zM21 18.5a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />`,
